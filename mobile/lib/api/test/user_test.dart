...
void main() {
  ...
  group(User, () {
    ...
    // bool isMFAEnabled
    test('to test the property `isMFAEnabled`', () async {
      // TODO
    });

    // String mfaSecret
    test('to test the property `mfaSecret`', () async {
      // TODO
    });

    // BuiltList<String> recoveryCodes
    test('to test the property `recoveryCodes`', () async {
      // TODO
    });
    ...
    // num diamonds
    test('to test the property `diamonds`', () async {
      // TODO
    });
    ...
    // BuiltList<Prediction> predictions
