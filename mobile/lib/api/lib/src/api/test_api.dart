...
class TestApi {
  ...
  Future<Response<void>> testControllerAddDiamond({ 
    ...
    final _path = r'/test/{userId}/add-diamond'.replaceAll('{' r'userId' '}', encodeQueryParameter(_serializers, userId, const FullType(String)).toString());
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> testControllerEndMatch({ 
    required String id,
    ...
    final _path = r'/test/{id}/end-match'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Prediction>> testControllerMakePrediction({ 
    required String userId,
    ...
    final _path = r'/test/{userId}/{matchId}/predict'.replaceAll('{' r'userId' '}', encodeQueryParameter(_serializers, userId, const FullType(String)).toString()).replaceAll('{' r'matchId' '}', encodeQueryParameter(_serializers, matchId, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> testControllerUpdateMatch({ 
    required String id,
    required TerminateMatchDto terminateMatchDto,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/test/{id}/update-match'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
